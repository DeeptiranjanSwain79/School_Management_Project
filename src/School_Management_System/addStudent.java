...
public class addStudent implements ActionListener{
    ...
    addStudent(){
        ...
        id__ = new JButton("ID");
        id__.setBounds(260, 50, 80, 40);
        id__.setBackground(Color.BLUE);
        id__.setForeground(Color.WHITE);
        frame.add(id__);
        id__.addActionListener(this);
...
//        id_.setVisible(false);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == save){
            String q = "insert into class_"+c.getSelectedItem()+" (id, name, father, mother, roll, password, dob, aadhaar) values" +
